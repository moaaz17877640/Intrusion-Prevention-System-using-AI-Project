...
plt.grid()
plt.legend()
plt.savefig(os.path.join(MODEL_DIR, 'roc_curve_svm.png'))
plt.close()
...
with open(os.path.join(MODEL_DIR, "svm_metadata.json"), 'w') as f:
    json.dump(metadata, f, indent=4)

print("\n✅ SVM Model, Scaler, and Metadata saved successfully.")