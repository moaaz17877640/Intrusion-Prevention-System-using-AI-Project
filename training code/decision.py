...
plt.grid()
plt.legend()
plt.savefig(os.path.join(MODEL_DIR, 'roc_curve_decision_tree.png'))
plt.close()

# === Save model and metadata ===
model_file = os.path.join(MODEL_DIR, "decision_tree_model.pkl")
scaler_file = os.path.join(MODEL_DIR, "decision_tree_scaler.pkl")
...
metadata = {
    "decision_tree_model": {
        ...
        "scaler_file": "decision_tree_scaler.pkl",
...
print("\n✅ Decision Tree Model, Scaler, and Metadata saved successfully.")