...
plt.grid()
plt.legend()
plt.savefig(os.path.join(MODEL_DIR, 'roc_curve_nn.png'))
plt.close()

# === Save model and metadata ===
model_file = os.path.join(MODEL_DIR, "neural_network_model.pkl")
scaler_file = os.path.join(MODEL_DIR, "neural_network_scaler.pkl")
...
print("\n✅ Neural Network Model, Scaler, and Metadata saved successfully.")