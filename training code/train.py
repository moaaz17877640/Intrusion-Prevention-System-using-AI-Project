...
# نستخدم متوسط القيم + 2*الانحراف المعياري لكل ميزة كعتبة
feature_thresholds = {}
...
# === الحفظ ===
model_file = os.path.join(MODEL_DIR, "default_model.pkl")
...
metadata = {
    "default_model": {
        ...
        "threshold": 0.5,  # تم تعديله بناءً على ROC إذا لزم الأمر
