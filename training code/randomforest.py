...
plt.grid()
plt.legend()
plt.savefig(os.path.join(MODEL_DIR, 'roc_curve_random_forest.png'))
plt.close()

# === Save model and metadata ===
model_file = os.path.join(MODEL_DIR, "random_forest_model.pkl")
scaler_file = os.path.join(MODEL_DIR, "random_forest_scaler.pkl")
...
with open(os.path.join(MODEL_DIR, "random_forest_metadata.json"), 'w') as f:
    json.dump(metadata, f, indent=4)

print("\n✅ Random Forest Model, Scaler, and Metadata saved successfully.")