...
plt.grid()
plt.legend()
plt.savefig(os.path.join(MODEL_DIR, 'roc_curve_naive_bayes.png'))
plt.close()

# === Save model and metadata ===
model_file = os.path.join(MODEL_DIR, "naive_bayes_model.pkl")
scaler_file = os.path.join(MODEL_DIR, "naive_bayes_scaler.pkl")
...
with open(os.path.join(MODEL_DIR, "naive_bayes_metadata.json"), 'w') as f:
    json.dump(metadata, f, indent=4)

print("\n✅ Naive Bayes Model, Scaler, and Metadata saved successfully.")