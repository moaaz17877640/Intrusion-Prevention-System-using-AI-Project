...
plt.grid()
plt.legend()
plt.savefig(os.path.join(MODEL_DIR, 'roc_curve_knn.png'))
plt.close()

# === Save model and metadata ===
model_file = os.path.join(MODEL_DIR, "knn_model.pkl")
scaler_file = os.path.join(MODEL_DIR, "knn_scaler.pkl")
...
with open(os.path.join(MODEL_DIR, "knn_metadata.json"), 'w') as f:
    json.dump(metadata, f, indent=4)

print("\n✅ KNN Model, Scaler, and Metadata saved successfully.")